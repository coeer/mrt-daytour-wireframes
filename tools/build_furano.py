...
KR_ITINERARY = [
    {"key": "sapporo_depart", "type": "pass", "time": "예정 08:00", "name": "삿포로 출발 🚗", "dur": "(숙소 픽업 또는 삿포로역 집합 후)"},
    {"key": "farm_tomita", "time": "예정 10:30", "name": "팜 토미타", "dur": "(약 60분 · 포토타임)", "peak": True,
     "color": "#9b5de5", "img": "img/tomita.jpg", "cap": "팜 토미타 라벤더 밭",
     "desc": "보랏빛 라벤더가 언덕 끝까지 💜 라벤더 소프트크림은 필수!"},
    {"key": "roller_coaster_road", "time": "예정 11:30", "name": "차창 감상: 제트코스터 로드", "dur": "(약 15분 · 하차 없음)",
     "color": "#06d6a0", "placeholder": "[ 제트코스터 로드 차창 시점 사진 ]",
     "desc": "롤러코스터처럼 오르내리는 언덕길, 창밖으로 흐르는 여름 🎢"},
    {"key": "shikisai_no_oka", "time": "예정 12:15", "name": "사계채의 언덕", "dur": "(약 60분)", "free": True,
     "color": "#ff5d8f", "img": "img/shikisai.jpg", "cap": "사계채의 언덕 무지개 꽃밭",
     "desc": "15헥타르 무지개 꽃밭, 계절마다 새로운 색 🌈"},
    {"key": "free_lunch", "type": "pass", "time": "예정 13:15", "name": "자유 점심 🍽️", "dur": "(약 1시간 · 개별 결제)",
     "desc": "정해진 단체 식사 NO, 내가 고르는 자유 점심"},
    {"key": "blue_pond", "time": "예정 15:00", "name": "청의 호수", "dur": "(약 30분 · 포토타임)",
     "color": "#00b4d8", "img": "img/aoiike.jpg", "cap": "청의 호수(아오이이케)",
     "desc": "SNS 최다 공유 블루 스폿, 오늘의 인생샷 📸"},
    {"key": "shirahige_falls", "time": "예정 15:35", "name": "시라히게 폭포", "dur": "(약 25분)",
     "color": "#2ec4b6", "img": "img/shirahige.jpg", "cap": "시라히게 폭포",
     "desc": "흰 수염처럼 흘러내리는 드문 잠수 폭포 💧"},
    {"key": "sapporo_return", "type": "pass", "time": "예정 16:00", "name": "삿포로로 출발 → 예정 18:30 삿포로 도착",
     "note": "⏰ 도로 상황에 따라 도착 시간이 앞뒤로 달라질 수 있습니다. 출발 시간이 정해진 교통편(항공·기차)이나 공연·레스토랑 예약은 가급적 다른 날짜에 잡아 주세요."},
]

ZH_ITINERARY = [
    {"key": "sapporo_depart", "type": "pass", "time": "预计 08:00", "name": "札幌出发 🚗", "dur": "(住宿接送或札幌站集合后)"},
    {"key": "farm_tomita", "time": "预计 10:30", "name": "富田农场", "dur": "(约60分钟·拍照时间)", "peak": True,
     "color": "#9b5de5", "img": "img/tomita.jpg", "cap": "富田农场薰衣草花田",
     "desc": "紫色薰衣草一路铺到山坡尽头 💜 薰衣草冰淇淋必尝!"},
    {"key": "roller_coaster_road", "time": "预计 11:30", "name": "车窗观赏：云霄飞车之路", "dur": "(约15分钟·不下车)",
     "color": "#06d6a0", "placeholder": "[ 云霄飞车之路 车内视角照片 ]",
     "desc": "像过山车一样起伏的坡道，窗外流动的夏天 🎢"},
    {"key": "shikisai_no_oka", "time": "预计 12:15", "name": "四季彩之丘", "dur": "(约60分钟)", "free": True,
     "color": "#ff5d8f", "img": "img/shikisai.jpg", "cap": "四季彩之丘彩虹花田",
     "desc": "15公顷彩虹花田，每个季节都有新颜色 🌈"},
    {"key": "free_lunch", "type": "pass", "time": "预计 13:15", "name": "自由午餐 🍽️", "dur": "(约1小时·各自结账)",
     "desc": "不是固定的团餐，是自己选的午餐"},
    {"key": "blue_pond", "time": "预计 15:00", "name": "青池", "dur": "(约30分钟·拍照时间)",
     "color": "#00b4d8", "img": "img/aoiike.jpg", "cap": "青池",
     "desc": "SNS上被分享最多的蓝色景点，拍出今天的人生照片 📸"},
    {"key": "shirahige_falls", "time": "预计 15:35", "name": "白须瀑布", "dur": "(约25分钟)",
     "color": "#2ec4b6", "img": "img/shirahige.jpg", "cap": "白须瀑布",
     "desc": "像白色胡须一样流下的罕见\"潜水瀑布\" 💧"},
    {"key": "sapporo_return", "type": "pass", "time": "预计 16:00", "name": "返程回札幌 → 预计18:30左右抵达札幌",
